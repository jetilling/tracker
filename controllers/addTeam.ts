...
let createTeam = (req: types.expressRequest, res: express.Response, next: express.NextFunction) => {
...
let addMember = (req: types.expressRequest, res: express.Response, next: express.NextFunction) => {
